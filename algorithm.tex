	...
	\begin{center}
		\begin{mdframed}
			\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3.5cm]
				...
				\node[state,align=center,minimum size=3cm,scale=0.75] [below left of=q0] (q1) {\footnotesize{$\{\epsilon\}$}\\$G$\\\footnotesize{\{"$AT$"\}}\\\scriptsize{$1$}};
				\node[state,align=center,minimum size=3cm,scale=0.75] [above left of=q0] (q2) {\footnotesize{$\{\epsilon\}$}\\$T$\\\footnotesize{\{"$AT$"\}}\\\scriptsize{$6$}};
		...
		\end{mdframed}
	\end{center}
	\caption{A small reference graph with left contexts (top) and right contexts (bottom) and $|c|$=2 explicitly shown}
	...
	\begin{subfigure}[t]{\textwidth}
		\begin{mdframed}
			\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3.5cm,scale=0.6]
				...
				\node[state,align=center] [below=0.3cm of q7] (q8) {$A$\\\scriptsize{$2$}};
				\node[state,align=center] [below=0.3cm of q8] (q9) {$T$\\\scriptsize{$3$}};
				\node[state,align=center] [below=0.3cm of q9] (q10) {$A$\\\scriptsize{$4$}};
				\node[state,align=center] [below=0.3cm of q10] (q11) {$G$\\\scriptsize{$5$}};
				\node[state,align=center] [below=0.3cm of q11] (q12) {$G$\\\scriptsize{$6$}};

				\node[state,align=center] [below=0cm of q2] (q13) {$T$\\\scriptsize{$3$}};
				\node[state,align=center] [below=0.3cm of q13] (q14) {$T$\\\scriptsize{$4$}};
				\node[state,align=center] [below=0.3cm of q14] (q15) {$T$\\\scriptsize{$5$}};
			\end{tikzpicture}
		\end{mdframed}
		\caption{$T=1$}
	\end{subfigure}
	\caption{The resulting candidate sets for mapping the string "ATA" against the reference genome from ~\ref{fig:explicit_contexts} with varying threshold T values)}
