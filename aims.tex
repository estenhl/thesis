...
\end{itemize}
In order to succeed with the two smaller goals, we created the \textit{GraphGenome} tool which implements the algorithm. This tool is available online, instructions on retrieving and using it can be found in Appendix \ref{sec:tool}.\\
\par\noindent
